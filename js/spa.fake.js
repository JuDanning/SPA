spa.fake = (function() {
    ...
    mockSio = (function() {
        var on_sio, emit_sio, send_listchange, listchaneg_idto, emit_mock_msg, callback_map = {};
        ...
        emit_sio = function(msg_type, data) {
            ...
            if (msg_type === 'leavechat') {
                ...
                if (listchaneg_idto) {
                    clearTimeout(listchaneg_idto);
                    listchaneg_idto = undefined;
                }
                send_listchange();
            }
        };
        ...
        send_listchange = function() {
            listchaneg_idto = setTimeout(function() {
